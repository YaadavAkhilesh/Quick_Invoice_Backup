...
//                 <div className="lgn-right-container">
...
//                                         <img src={userIcon} alt="Username icon" height="38" width="38" className="mx-auto" />
//                                     </span>
...
//                                 {errors.password && (
//                                     <div className="invalid-feedback d-flex align-items-center gap-1 f-14">
...
//                                 {errors.password && (
//                                     <div className="invalid-feedback d-flex align-items-center gap-1 f-14 mb-0">
//                                         <img src={erricon} alt="Error icon" className="error-icon me-1" height="15" width="15" />
...
//                                     </div>
//                                     <a href="#" className="text-decoration-none text-center" aria-label="Forgot password">Forgot Password?</a>
//                                 </div>
